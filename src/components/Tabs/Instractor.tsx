      ...
      <div className="flex flex-col md:flex-row gap-8">
        <div className="w-full md:w-1/4 flex justify-center md:justify-start">
          <div className="w-[180px] h-[180px] overflow-hidden">
            <Image
              src={course.instructor?.avatar || '/assets/images/frame.png'}
        ...
        <div className="w-full md:w-3/4">
          <h3 className="text-xl font-bold mb-2 text-gray-800">{course.instructor?.name || 'John Doe'}</h3>
          <p className="text-orange-600 font-medium mb-4">{course.instructor?.title || 'WordPress Expert'}</p>
          ...
          <div className="flex flex-wrap gap-6 mb-6">
            <div className="flex items-center">
              <span className=" w-8 h-8 flex items-center justify-center"><Users size={18} className="text-orange-600 mr-2" /></span>
              <span className="text-gray-700">156 Students</span>
            </div>
            <div className="flex items-center">
              <span className=" w-8 h-8 flex items-center justify-center"><BookOpen size={18} className="text-orange-600 mr-2" /></span>
              <span className="text-gray-700">20 Lessons</span>
            </div>
          </div>
          
            <div className="flex space-x-4">
              <span className="text-gray-500 ml-2">Follow:</span>
